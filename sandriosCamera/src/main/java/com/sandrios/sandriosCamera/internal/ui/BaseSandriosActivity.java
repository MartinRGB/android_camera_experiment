...
public abstract class BaseSandriosActivity<CameraId> extends SandriosCameraActivity<CameraId>
    ...
    private void startPreviewActivity() {
        final Intent intent = PreviewActivity.newIntent(this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_PREVIEW_CODE) {
                ...
                if (PreviewActivity.isResultConfirm(mData)) {


                    //Intent resultIntent = new Intent();
                    //resultIntent.putExtra(CameraConfiguration.Arguments.FILE_PATH,PreviewActivity.getMediaFilePatch(mData));
                    //setResult(RESULT_OK, resultIntent);
                    //finish();
                } else if (PreviewActivity.isResultCancel(mData)) {
                   // setResult(RESULT_CANCELED);
                    //finish();
                } else if (PreviewActivity.isResultRetake(mData)) {
